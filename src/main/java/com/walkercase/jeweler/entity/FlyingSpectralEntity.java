...
public abstract class FlyingSpectralEntity extends SpectralEntity {
    protected FlyingSpectralEntity(EntityType<? extends SpectralEntity> p_20806_, Level p_20807_) {
