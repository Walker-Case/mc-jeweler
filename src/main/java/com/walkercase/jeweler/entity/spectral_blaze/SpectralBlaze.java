...
public class SpectralBlaze extends SpectralEntity {

    private float allowedHeightOffset = 0.5F;
    private int nextHeightOffsetChangeTick;
    private static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(SpectralBlaze.class, EntityDataSerializers.BYTE);

    public SpectralBlaze(EntityType<? extends SpectralEntity> p_21803_, Level p_21804_) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new SpectralBlaze.BlazeAttackGoal(this));
    ...
    class BlazeAttackGoal extends Goal {
        private final SpectralBlaze blaze;
        private int attackStep;
        private int attackTime;
        private int lastSeen;

        public BlazeAttackGoal(SpectralBlaze p_32247_) {
            this.blaze = p_32247_;
