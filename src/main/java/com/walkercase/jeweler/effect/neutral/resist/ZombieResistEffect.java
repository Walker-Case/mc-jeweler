...
/**
 * Zombies do less damage BUT Skeletons do more.
 */
public class ZombieResistEffect implements INeutralResistEffect {
    @Override
    ...
    public ResourceLocation effectID() {
        return new ResourceLocation(JewelerMain.MODID, "zombie_resist");
    }
